...
/**
 * This class provides functionality to convert an image into FaceProject image
 *
 * PHP Version 5
 *
 * @category  FaceProject
...
{
   /**
    * The number of pixels to add as the reflection on the bottom of image
    * 
    * @var integer
    */
   const BOTTOM_PIXEL_SIZE = 30;
   ...
   public function setImage($path)
   {
      ...
      imagecopy($this->newImage, $this->originalImage, 0, 0, 0, 0, $width, $height);
   ...
   protected function addReflection()
   {
      ...
      for ($y = $this->height; $y < $this->height + self::BOTTOM_PIXEL_SIZE; $y++)
      {
         $line1x1 = 0;
         $line1x2 = null;
         $line2x1 = null;
         ...
         imageline($tempImage, $line1x1, $y, $line1x2, $y, $white);
         imageline($tempImage, $line2x1, $y, $line2x2, $y, $white);
      }
